...
import static com.huuanh.demo.rsa.common.SecurityConstants.EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
  ...
  public Authentication attemptAuthentication(HttpServletRequest req,
    ...
    try {
      CustomUserDetail creds = new ObjectMapper()
          .readValue(req.getInputStream(), CustomUserDetail.class);
